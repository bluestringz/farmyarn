...
const Api = (() => {
  ...
  return {
    ...
    giftToFriend: (itemId, friendUserId) => request('POST', '/api/shop/gift-to-friend', { itemId, friendUserId }),
    ...
    triggerFireworks: (objectId) => request('POST', '/api/farm/trigger-fireworks', { objectId }),
